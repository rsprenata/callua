...
public class ChamadoServlet extends HttpServlet {
    ...
    private Mensagem formValido(Chamado chamado) {
        ...
        } else if (cliente.getTelefoneCelular().length() != 11  || !ehInteiro(cliente.getTelefoneCelular())) {
        ...
        } else if (cliente.getEndereco().getEndereco()== null || "".equals(cliente.getEndereco().getEndereco())) {
            mensagem = new Mensagem("Endereço é obrigatório !!!");
        } else if (cliente.getEndereco().getEndereco().length() > 128) {
            mensagem = new Mensagem("No máximo 128 caracteres no endereço !!!");
        } else if (cliente.getEndereco().getCep()== null || "".equals(cliente.getEndereco().getCep())) {
            mensagem = new Mensagem("CEP é obrigatório !!!");
        } else if (cliente.getEndereco().getCep().length() != 8 || !ehInteiro(cliente.getEndereco().getCep())) {
